...
if [[ ${HOSTNAME} =~ monde ]]; then
  ...
  for blopt in 1 2; do
    ...
    #   --1=0.2,0.4,1,2 hs_katmos${blopt}_t42l20s
    # # Continuation runs
    # ./drycore_series -dt=1200 -c=8 -d=100 -ts=0 \
    #   -te=3500 -kts=500 -kte=3500 \
    #   --1=60:40,40:20,20:10,10:4 hs_tgrad${blopt}_t42l20s
    #   # --1=10,20,40,90,120,150,200 hs_tgrad1_t42l20s
    # ./drycore_series -dt=1200 -c=8 -d=100 -ts=0 \
    #   -te=3500 -kts=500 -kte=3500 \
    #   --1=40:100,100:200,200:400,400:1000 hs_katmos${blopt}-mean_t42l20s
    # ./drycore_series -dt=1200 -c=8 -d=100 -ts=0 \
    #   -te=3500 -kts=500 -kte=3500 \
    #   --1=40:100,100:200,200:400,400:1000 hs_katmos${blopt}_t42l20s
    # # Full runs
    # ./drycore_series -dt=1200 -c=8 -d=100 -ts=500 \
    #   -te=3500 -kts=500 -kte=3500 \
    #   --1=4,10,20,40,40:100,100:200,200:400,400:1000 hs_katmos${blopt}-mean_t42l20s
    # ./drycore_series -dt=1200 -c=8 -d=100 -ts=500 \
    #   -te=3500 -kts=500 -kte=3500 \
    #   --1=4,10,20,40,40:100,100:200,200:400,400:1000 hs_katmos${blopt}-mean_t42l20s
    # ./drycore_series -dt=1200 -c=8 -d=100 -ts=500 \
    #   -te=3500 -kts=500 -kte=3500 \
    #   --1=4,10,20,40:100,100:200,200:400,400:1000 hs_katmos${blopt}_t42l20s
    # Global temp
    # ./drycore_series -dt=1200 -c=8 -d=100 -ts=0 \
    #   -te=1500 -kts=200 -kte=1500 \
    #   --1=310,320 hs_tmean${blopt}_t42l20s
    #   # --1=280,290,310,320 hs_tmean${blopt}_t42l20s
  done
    ...
    for blopt in 2; do
      for k in 40 20 60 10 100; do
        ...
        ./drycore_series -r -dt=$dt -c=8 -d=100 -ts=0 \
          ...
          --1=$k:$k --2=0.5 hs_katmos${blopt}-arctic_t42l20s
        ./drycore_series -r -dt=$dt -c=8 -d=100 -ts=0 \
          -te=$te -kts=500 -kte=3500 \
          --1=$k:$k --2=-0.5 hs_katmos${blopt}-vortex_t42l20s
        ./drycore_series -r -dt=$dt -c=8 -d=100 -ts=0 \
          -te=$te -kts=500 -kte=3500 \
          --1=$k:$k --2=0.5 hs_katmos${blopt}-tropical_t42l20s
        # 2xCO2 and 4xCO2 global
        ./drycore_series -r -dt=$dt -c=8 -d=100 -ts=0 \
          -te=$te -kts=500 -kte=3500 \
          --1=$k:$k --2=0.03 hs_katmos${blopt}-global_t42l20s
        ./drycore_series -r -dt=$dt -c=8 -d=100 -ts=0 \
          -te=$te -kts=500 -kte=3500 \
          --1=$k:$k --2=0.06 hs_katmos${blopt}-global_t42l20s
        ...
        ./drycore_series -r -dt=$dt -c=8 -d=100 -ts=0 \
          -te=$te -kts=500 -kte=3500 \
          --1=$k:$k --2=0.2 hs_katmos${blopt}-surface_t42l20s
        ./drycore_series -r -dt=$dt -c=8 -d=100 -ts=0 \
          -te=$te -kts=500 -kte=3500 \
          --1=$k:$k --2=0.4 hs_katmos${blopt}-surface_t42l20s
      done
      for k in 40 20 60 10 100; do
      # for k in 40 20 60 4 400; do
        ...
        ./drycore_series -r -dt=$dt -c=8 -d=100 -ts=0 \
          -te=$te -kts=500 -kte=3500 \
          --1=$k --2=300:280,300:290,300:310,300:320 hs_katmos${blopt}-tmean_t42l20s
        # Temperature gradient
        ./drycore_series -r -dt=$dt -c=8 -d=100 -ts=0 \
          -te=$te -kts=500 -kte=3500 \
          --1=$k --2=60:40,60:90,60:120,60:150,60:20 hs_katmos${blopt}-tgrad_t42l20s
      done
    done
  done
